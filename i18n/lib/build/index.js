...
const { readSourceEntries } = require('../shared/entries');
const {
...
const { checkArtifacts, generateArtifacts, writeArtifacts } = require('./artifacts');
const { collectIssues } = require('./analysis');
const { printHelp, printNamespaceList } = require('./help');
const { printIssues, printLocalSummary, printReport } = require('./reporting');
