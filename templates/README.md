...
The templates use Cloudflare Pages as the primary CDN and GitHub Raw as the
automatic network fallback.

Fixed Cloudflare Pages URL pattern:
...
- they read from the fixed Cloudflare Pages URL first
...
After generated locale changes, the repository waits for Cloudflare Pages and
